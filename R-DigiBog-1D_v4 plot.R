...
for (i in 1:365){
  rank <- sort(daily_wtd_output[,i])[c(75,480,1500,2520,2925)] # 2.5%, 16%, 50%, 84%, 97.5%
...
for (i in 1:365){
  rank <- sort(((daily_prod_output-daily_decay_output)*10000)[,i])[c(75,480,1500,2520,2925)] # 2.5%, 16%, 50%, 84%, 97.5%
...
for (i in 1:365){
  rank <- sort(daily_melt_output[,i])[c(75,480,1500,2520,2925)] # 2.5%, 16%, 50%, 84%, 97.5%
...
for (i in 1:365){
  rank <- sort(daily_pond_output[,i])[c(75,480,1500,2520,2925)] # 2.5%, 16%, 50%, 84%, 97.5%
